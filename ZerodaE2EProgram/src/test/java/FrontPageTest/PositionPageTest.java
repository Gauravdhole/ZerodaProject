...
import FrontPage.PositionPage;

public class PositionPageTest extends BasedClassBrowsers {
	...
	public void  VerifyPosition() {
		PositionPage pt= new PositionPage (driver);
		pt.verifyClicOnPositionElement().click();
		pt.verifyClickOnStarButton().click();
		pt.verifyTypingOntestBOX().sendKeys("puma");
	}
