...
import FrontPage.HoldingPage;

public class HoldingTest extends BasedClassBrowsers {
	...
	@BeforeClass
	 ...
	 public void GetStarOrder() throws IOException {
	...
	@Test (priority = 2)
	public void VerifyHoldingTest() {
		
		HoldingPage  hh= new HoldingPage(driver);
		hh.verifyClickOnHoldingElement().click();
		hh.verifyclickOnStardButton().click();
		hh.verifyclickTypedButton().sendKeys("Adidas");
